...
public class UserHttpService implements HttpService {
    ...
    @Inject
    public UserHttpService(UserPluginConfig config, UserStorage storage, PrestoQueryExecutor executor, PrestoConfig prestoConfig, EventSchemaMetastore metastore) {
    ...
    @JsonRequest
    @Path("/get")
    public User getUser(UserSpecificRequest userRequest) {
