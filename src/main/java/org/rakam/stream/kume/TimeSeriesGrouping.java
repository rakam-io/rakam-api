...
/**
 * Created by buremba <Burak Emre Kabakcı> on 31/12/14 04:12.
 */
public class TimeSeriesGrouping {
    ...
    public static class UniqueXTimeSeriesStreamProcessor implements TimeSeriesStreamProcessor {
        ...
        public UniqueXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval) {
    ...
    public static class SumXTimeSeriesStreamProcessor extends TimeSeriesCounterMapHandler {
        ...
        public SumXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            super(cluster, field, groupBy, interval, isOrdered, lazySorted);
        }
    ...
    public static class MinimumXTimeSeriesStreamProcessor extends TimeSeriesCounterMapHandler {
        ...
        public MinimumXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            super(cluster, field, groupBy, interval, isOrdered, lazySorted);
        }
    ...
    public static class MaximumXTimeSeriesStreamProcessor extends TimeSeriesCounterMapHandler {
        ...
        public MaximumXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            super(cluster, field, groupBy, interval, isOrdered, lazySorted);
        }
    ...
    public static class CountXTimeSeriesStreamProcessor extends TimeSeriesCounterMapHandler {
        public CountXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            super(cluster, field, groupBy, interval, isOrdered, lazySorted);
        }
    ...
    public static class CountTimeSeriesStreamProcessor extends TimeSeriesCounterMapHandler {
        ...
        public CountTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            super(cluster, field, groupBy, interval, isOrdered, lazySorted);
        }
    ...
    public static class AverageXTimeSeriesStreamProcessor implements TimeSeriesStreamProcessor {
        ...
        public AverageXTimeSeriesStreamProcessor(Cluster cluster, FieldScript<Object> field, Interval interval, boolean isOrdered, boolean lazySorted) {
            this.field = field;
            this.interval = interval;
    ...
    public abstract static class TimeSeriesCounterMapHandler implements TimeSeriesStreamProcessor {
        ...
        public TimeSeriesCounterMapHandler(Cluster cluster, FieldScript<Object> field, FieldScript<String> groupBy, Interval interval, boolean isOrdered, boolean lazySorted) {
            this.field = field;
            this.interval = interval;
            this.groupBy = groupBy;
