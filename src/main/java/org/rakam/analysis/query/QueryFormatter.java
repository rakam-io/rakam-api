...
/**
 * Created by buremba <Burak Emre Kabakcı> on 21/02/15 04:01.
 */
        ...
        extends AstVisitor<Void, Integer>
{
    ...
    public QueryFormatter(StringBuilder builder, String plugin, String project)
    {
    ...
    {
        builder.append(plugin).append(".").append(project).append(".").append(node.getName().toString());
        return null;
    }
