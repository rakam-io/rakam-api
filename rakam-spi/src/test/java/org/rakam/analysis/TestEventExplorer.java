...
public abstract class TestEventExplorer
{
            ...
            throws Exception
    {
        Map<TimestampTransformation, Set> GROUPING = ImmutableMap.<TimestampTransformation, Set>builder()
                ...
                .put(HOUR, ImmutableSet.of(of(LocalDate.parse("1970-01-01T00:00:00Z"), "test", 36L), of(parse("1970-01-01T01:00:00Z"), "test", 36L), of(parse("1970-01-01T02:00:00Z"), "test", 28L)))
