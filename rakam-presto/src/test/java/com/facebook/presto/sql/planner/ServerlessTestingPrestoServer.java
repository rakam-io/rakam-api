...
public class ServerlessTestingPrestoServer implements Closeable
{
    ...
    public ServerlessTestingPrestoServer()
            throws Exception
    {
        this(ImmutableList.of());
    }

    public ServerlessTestingPrestoServer(List<Module> additionalModules)
            throws Exception
    {
        this(true, ImmutableMap.of(), null, null, new SqlParserOptions(), additionalModules);
    }

    public ServerlessTestingPrestoServer(boolean coordinator,
