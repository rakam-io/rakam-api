        ...
        extends ContinuousQueryService
{
    ...
    public QueryExecution create(String project, ContinuousQuery report, boolean replayHistoricalData)
    {
        ...
        prestoQueryExecution = executor.executeRawStatement(prestoQuery, ZoneOffset.UTC, builder.build(), config.getStreamingConnector(), null, true);
    ...
    public QueryExecution refresh(String project, String tableName)
    {
        ...
        return executor.executeRawStatement(format("create or replace view %s.\"%s\".\"%s\" as %s",
                ...
                config.getStreamingConnector(), null, true);
    }
}
