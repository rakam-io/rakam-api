...
public class RedshiftUtils {
     ...
     * 
     * @param client
     *        The {@link com.amazonaws.services.redshift.AmazonRedshiftClient} with read and write permissions
     ...
     * 
     * @param client
     *        The {@link com.amazonaws.services.redshift.AmazonRedshiftClient} with read permissions
     * @param clusterIdentifier
    ...
    /**
     * Helper method to convert an Amazon Redshift {@link com.amazonaws.services.redshift.model.Endpoint} and database name to JDBC connection
     * String
     * 
     * @param endpoint
    ...
    public static void createRedshiftTable(String redshiftURL,
        ...
        Connection conn = DriverManager.getConnection(redshiftURL, properties);
    ...
    public static boolean tableExists(String redshiftURL, Properties properties, String tableName) {
        Connection conn = null;
        try {
            conn = DriverManager.getConnection(redshiftURL, properties);
